...
const generatedModel = {
  ...
  */
  async findByacademic_id(key) {
    return await Database.getConnection().models.User.findAll({ where: { "academic_id": key } });
  },
  ...
  */
  async findByrole_id(key) {
    return await Database.getConnection().models.User.findAll({ where: { "role_id": key } });
  },
  ...
  */
  async findByschool_id(key) {
    return await Database.getConnection().models.User.findAll({ where: { "school_id": key } });
  },
