...
const generatedControllers = {
  ...
  init: router => {
    ...
    router.get(baseUrl + "/findByacademic_id/:key", authorize([]), UserController.findByacademic_id);
    router.get(baseUrl + "/findByrole_id/:key", authorize([]), UserController.findByrole_id);
    router.get(baseUrl + "/findByschool_id/:key", authorize([]), UserController.findByschool_id);
  ...
  */
  findByacademic_id: async (req, res) => {
    try {
      const result = await UserModel.findByacademic_id(req.params.key);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
  ...
  */
  findByrole_id: async (req, res) => {
    try {
      const result = await UserModel.findByrole_id(req.params.key);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
  ...
  */
  findByschool_id: async (req, res) => {
    try {
      const result = await UserModel.findByschool_id(req.params.key);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
