...
class UserApiGenerated {
  ...
  */
  ...
  /**
  * UserService.findByacademic_id
  *   @description CRUD ACTION findByacademic_id
  *   @param Objectid key Id of model to search for
  *
  */
  static findByacademic_id(id) {
    return axios.get(UserApiGenerated.contextUrl + "/findByacademic_id/" + id )
      .then(response => {
        return response.data;
      })
      .catch(error => {
  ...
  /**
  * UserService.findByrole_id
  *   @description CRUD ACTION findByrole_id
  *   @param Objectid key Id of model to search for
  *
  */
  static findByrole_id(id) {
    return axios.get(UserApiGenerated.contextUrl + "/findByrole_id/" + id )
      .then(response => {
        return response.data;
      })
      .catch(error => {
  ...
  /**
  * UserService.findByschool_id
  *   @description CRUD ACTION findByschool_id
  *   @param Objectid key Id of model to search for
  *
  */
  static findByschool_id(id) {
    return axios.get(UserApiGenerated.contextUrl + "/findByschool_id/" + id )
      .then(response => {
        return response.data;
      })
      .catch(error => {
